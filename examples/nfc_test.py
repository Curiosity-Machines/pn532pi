...
if __name__ == '__main__':
    if len(sys.argv) > 1 and sys.argv[1] = "antenna"
        ANTENNA_TEST = 1
    else:
        print("""
    Default script waits for NFC cards and then attempts to authenticate and read extended data
    Use 'nfc_test antenna' to run the antenna presence tests""")
        sys.exit(0)
